...
const finalText = 'Вы отлично справились! В качестве вознаграждения забирайте [скрипт для медрегистратора](./scenario-data/scenario1script.docx), если врач задерживается. Пройдите тренажер несколько раз и тогда он вам не понадобится.';
